...
public class GeradorQrCode {
	...
	// Este método irá gerar um QR Code com o texto - "Este é o meu primeiro QR
	// Code" e salvá-lo no local especificado
	...
	/*
	 * Este método leva o texto a ser codificado, a largura e a altura do QR Code, e
	 * retorna o QR Code na forma de uma matriz de bytes
	 */
	/*
	 * Se deseja retornar a imagem do QR Code como resposta a uma solicitação http.
	 * Você pode retornar a matriz de bytes no corpo da sua resposta http usando
	 * este método
	 */
